...
namespace RxyEx.Bots.DotNet
{
    public class Service
    {
        ...
        public RyxExConfiguration Config { get; }
        public Web3 Web3 { get; }
        public Contract RyxExContract { get; }
        ...
        internal async Task<TransactionReceipt> TakeOrder(Order order, BigInteger amount)
        {
            ...
            var fnTest = RyxExContract.GetFunction("testTrade");
            ...
            var fnTrade = RyxExContract.GetFunction("trade");
            ...
            var encoded = Web3.OfflineTransactionSigner.SignTransaction(Config.PrivateKey, Config.AddressRyxEx, amount,
        ...
        internal Order CreateOrder(OrderType orderType, BigInteger expires, BigInteger price, BigInteger amount)
        {
            ...
            var contractAddr = Config.AddressRyxEx;
        ...
        internal async Task<BigInteger> GetRyxExBalance(string token, string user)
        {
            BigInteger balance = 0;
            ...
            try
            {
                ...
                var tokenFunction = RyxExContract.GetFunction("balanceOf");
