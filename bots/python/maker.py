#!/usr/bin/python3
#
# maker.py: RyxEx maker client
# =================================
#
# This client waits until the RyxEx order book is available,
# determines a good buy and sell price and creates new buy and
# sell orders using the RyxEx WebSocket API.
#
...
# Installation:
# =============
# This client comes with service.py that contains common RyxEx API service facilities.
...
# Import our Python RyxEx API service,
# that automatically maintains the connection,
# updates the order and trade books,
# and allows for reuse of code throughout
# different RyxEx maker and taker clients.
from ryxexclientservice import RyxExClientService

if __name__ == "__main__":
    print("RyxEx API client in python using websocket")
    ...
    es = RyxExClientService()
    es.start(userAccount, token)
    print("RyxExClientService started")
