...
from ryxexclientservice import *
...
# Real RyxEx Contract Address
ryxExContractAddr = '0x56a20f5c2ad2d88d635783780a7a1ad0e50df492'
# Real GRX token
...
class TestTaker(unittest.TestCase):
    ...
    def test_createSellOrder(self):
        ...
        self.assertEqual(result['contractAddr'], ryxExContractAddr)
